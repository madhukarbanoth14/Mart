...
async function seedStockForCompany(companyId, opts = {}) {
    ...
    const holders = await prisma.user.findMany({
        where: {
            companyId,
            role: { in: [client_1.UserRole.ADMIN, client_1.UserRole.DEALER] },
        },
    ...
    for (const holder of holders) {
        const qty = holder.role === client_1.UserRole.ADMIN ? warehouseQty : dealerQty;
...
async function ensureLegacyDemoDealerWithStock() {
    ...
    console.log(`Legacy demo-company stock: ${stock.rowCount} rows (${stock.productCount} SKUs × ${stock.holderCount} holders)`);
}
const MANUFACTURERS = [
...
const PRODUCTS = [
    {
        ...
        brand: 'Horlicks',
        shelf: client_1.ProductShelf.MILK_DRINKS,
        weight: '200g',
        mrp: 99,
        dealerPrice: 89.92,
        caseQty: 48,
        imageUrl: 'https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQz38F7LT4jfQlaY8nLnMZcD-EWp7LADxR2HKkoDQv7AI4Nq5BjDS5x6TT9rzJFT0t3wb8h8TJtp_hO9juTiP3crA6ffRvMUMLyMDhws_sJUr9qVi_hyA0dgAgl8Ag65h44Pwr_lJ8&usqp=Cac',
    },
    {
        sku: '23',
        ...
        dealerPrice: 101.95,
        caseQty: 48,
        imageUrl: 'https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTAa2bGhm3q5lSvhRSj5iaiYdkbCtS6WKfw-VqB5KKl8RDHfAD8Hxqzu3ClISitH0HDsRmsK4Ut7vgrXXpWT4xHTzXQCqXYTmaiYUF6GKEvS8EbrJPdrjGNELRWf1YD20W4M8-Cw2Y&usqp=CAc',
    },
    {
        sku: '24',
        name: 'Tide Plus Double Power Detergent Powder, Jasmine & Rose',
        brand: 'Tide',
        shelf: client_1.ProductShelf.DETERGENTS,
        weight: '',
        mrp: 10,
        dealerPrice: 8.17,
        caseQty: 60,
    ...
    },
    {
        ...
        brand: 'Whisper',
        shelf: client_1.ProductShelf.FEMININE_BABY_CARE,
        weight: '6pcs',
        mrp: 50,
        dealerPrice: 39.77,
        caseQty: 64,
    ...
    },
    {
        ...
        shelf: client_1.ProductShelf.SHAMPOOS,
        weight: '5ml',
        mrp: 2,
        dealerPrice: 1.43,
        caseQty: 1200,
    ...
    },
    {
        ...
        brand: 'Vicks',
        shelf: client_1.ProductShelf.GENERAL_CARE,
        weight: '310.5g',
        mrp: 230,
        dealerPrice: 192.13,
        caseQty: 32,
    ...
    },
    {
        ...
        brand: 'Aashirvaad',
        shelf: client_1.ProductShelf.ATTA,
        weight: '5kg',
        mrp: 263,
        dealerPrice: 243.0,
        caseQty: 6,
    ...
    },
    {
        ...
        brand: 'Sunfeast',
        shelf: client_1.ProductShelf.BISCUITS_COOKIES,
        weight: '28g',
        mrp: 5,
        dealerPrice: 4.53,
        caseQty: 180,
    },
    {
        ...
        brand: 'Sunfeast',
        shelf: client_1.ProductShelf.NOODLES,
        weight: '70g',
        mrp: 25,
        dealerPrice: 22.3,
        caseQty: 144,
    },
    {
        ...
        brand: 'Sunfeast',
        shelf: client_1.ProductShelf.CHOCOLATES,
        weight: '180g',
        mrp: 177,
        dealerPrice: 161.07,
        caseQty: 24,
    },
    {
        ...
        brand: 'Mangaldeep',
        shelf: client_1.ProductShelf.AGARBATTIS,
        weight: '100pcs',
        mrp: 35,
        dealerPrice: 25.64,
        caseQty: 120,
    },
    {
        ...
        brand: 'Vivel',
        shelf: client_1.ProductShelf.SOAPS,
        weight: '100g',
        mrp: 26,
        dealerPrice: 22.77,
        caseQty: 72,
    },
    {
        ...
        brand: 'Classmate',
        shelf: client_1.ProductShelf.STATIONERY,
        weight: '1pc',
        mrp: 34,
        dealerPrice: 25.53,
        caseQty: 108,
    ...
    },
    {
        ...
        brand: 'Nescafe',
        shelf: client_1.ProductShelf.COFFEE,
        weight: '1.3g',
        mrp: 2,
        dealerPrice: 1.81,
        caseQty: 4680,
    },
    {
        ...
        brand: 'Maggi',
        shelf: client_1.ProductShelf.SAUCE,
        weight: '64g',
        mrp: 35,
        dealerPrice: 32.14,
        caseQty: 80,
    ...
    },
    {
        ...
        dealerPrice: 180.33,
        caseQty: 30,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQABWAukuBl5RBBOd3f5MXFsI3YZSovnMkvEA&s',
    },
    {
        sku: '51',
        ...
        dealerPrice: 29.91,
        caseQty: 216,
        imageUrl: 'https://images.apollo247.in/pub/media/catalog/product/C/H/CHA0019_1-JULY23_1.jpg',
    },
    {
        sku: '52',
        name: 'Gold Drop Refined Sunflower Oil',
        brand: 'Gold Drop',
        shelf: client_1.ProductShelf.EDIBLE_OIL,
        weight: '5L',
        mrp: 1188,
        dealerPrice: 883.0,
        caseQty: 4,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwtm4PLya1ZH5PdEMyGqfJiR6HvHFNGJ8uXw&s',
    },
    {
        sku: '53',
        ...
        dealerPrice: 171.12,
        caseQty: 16,
        imageUrl: 'https://5.imimg.com/data5/GLADMIN/Default/2022/6/QW/UF/BS/106185266/freedom-refined-sunflower-oil.jpeg',
    },
    {
        sku: '54',
        ...
        dealerPrice: 179.06,
        caseQty: 10,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnQ6D_s5zEvpwQqrGJ5y9aPHn0G2D8dEpyxQ&s',
    },
    {
        sku: '55',
        ...
        dealerPrice: 122.5,
        caseQty: 10,
        imageUrl: 'https://www.jiomart.com/images/product/original/494574562/ruchi-gold-refined-palmolein-oil-750g-product-images-o494574562-p612654654-0-202510171656.jpg?im=Resize=(1000,1000)',
    },
    {
        sku: '56',
        ...
        dealerPrice: 175.75,
        caseQty: 16,
        imageUrl: 'https://www.jiomart.com/images/product/original/490000064/vijaya-filtered-groundnut-oil-1-l-product-images-o490000064-p490000064-0-202203151517.jpg',
    },
    {
        sku: '57',
        name: 'Vijaya Deepam Oil',
        brand: 'Vijaya',
        shelf: client_1.ProductShelf.NON_EDIBLE_OIL,
        weight: '1L',
        mrp: 211,
        dealerPrice: 160.77,
        caseQty: 12,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhRHY78ncX-E1LbJk1RT0QEnxfxzf23RrzfQ&s',
    },
    {
        sku: '58',
        ...
        dealerPrice: 63.14,
        caseQty: 32,
        imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYHjGp3j4GpvJkGV5ByZcpOxX-w7GGAJbSIw&s',
    },
];
function toDecimal(value) {
    return new client_1.Prisma.Decimal(value.toFixed(2));
}
function placeholderImage(brand, name) {
    const label = encodeURIComponent(`${brand} ${name}`.slice(0, 48));
    return `https://dummyimage.com/600x600/1f2937/f9fafb.png&text=${label}`;
}
async function purgeLegacyDemoAccounts() {
    const legacyEmails = [
        'admin@martdemo.com',
...
async function main() {
    ...
    if (!adminPasswordPlain || adminPasswordPlain.length < 8) {
        throw new Error('Set SEED_ADMIN_PASSWORD (min 8 chars) in .env before running seed — only one admin account is created.');
    }
    const adminName = (process.env.SEED_ADMIN_NAME ?? 'FlashMart Admin').trim();
    const companyName = (process.env.SEED_COMPANY_NAME ?? 'FlashMart Distribution').trim();
    ...
    const brands = await Promise.all(BRANDS.map((b) => prisma.brand.upsert({
        where: { name: b.name },
        update: {
    ...
    const createdProducts = await Promise.all(PRODUCTS.map(async (row) => {
        ...
        return prisma.product.upsert({
            ...
            update: {
                ...
                brandId: brand.id,
                companyId: company.id,
                brandType: client_1.BrandType.OTHER,
                shelf: row.shelf,
                weight,
                mrp,
                dealerPrice,
    ...
    console.log(`Primary company stock: ${primaryStock.rowCount} rows (${primaryStock.productCount} SKUs × ${primaryStock.holderCount} holders)`);
