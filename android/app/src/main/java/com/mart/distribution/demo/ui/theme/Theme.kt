...
private val WholesaleLight =
    lightColorScheme(
        ...
        onPrimaryContainer = WholesaleBlueTintInk,
        secondary = WholesaleDealerBlue,
        onSecondary = Color.White,
        secondaryContainer = WholesaleDealerBlueTint,
        onSecondaryContainer = WholesaleDealerBlue,
        tertiary = WholesaleGold,
        onTertiary = Color.White,
        tertiaryContainer = WholesaleGoldTint,
        onTertiaryContainer = WholesaleGoldInk,
